...
int Peek(const StringQueue *q, string *x)
{
	if (IsEmpty(q))
	{
		*x = " ";
...
int Tail(const StringQueue* q, string* x)
{
	if (IsEmpty(q))
	{
		*x = " ";
...
int Search(const StringQueue *q, string x)
{
